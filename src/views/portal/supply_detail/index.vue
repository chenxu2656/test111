...
<template>
  ...
  <div class="all_layout">
    <div class="all_card">
      <el-card shadow="never">
        ...
        <el-card shadow="never" style="background-color: aliceblue">
          <el-text> 需求类型：{{ supplyDetail.data.type }} </el-text>
        ...
        <div style="float: right; margin-top: 3vh">
          ...
          >
          IP来自{{ checkAddress(supplyDetail.data.company_location) }}
        </div>
      </el-card>
      <el-card class="bottomC" shadow="never">
        ...
        <div>
          <el-steps
            style="max-width: 55vw; margin-top: 5vh"
            :active="2"
            align-center
          >
    ...
    <el-card class="rightC" shadow="never">
      ...
      <el-card
        shadow="never"
        v-for="i in supplyInfos"
        class="recommend"
        :key="i"
      >
        <div style="float: left">
          <img
            src="../../../assets/img/supply.jpg"
            width="60px"
