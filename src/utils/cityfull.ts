export default [
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { value: '440499', label: '香洲区横琴校区(由澳门特别行政区实施管辖)' }
        ]
      },
      {
        value: '440500',
      ...
      },
      {
        value: '441900',
        label: '东莞市',
        children: [{ value: '441999', label: '东莞市' }]
      },
      {
        value: '442000',
        label: '中山市',
        children: [{ value: '442099', label: '中山市' }]
      },
      {
        value: '445100',
        label: '潮州市',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        value: '460400',
        label: '儋州市',
        children: [{ value: '460499', label: '儋州市' }]
      },
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { value: '530825', label: '镇沅县' },
          { value: '530826', label: '江城哈尼族彝族自治县' },
          { value: '530827', label: '孟连县' },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        value: '620200',
        label: '嘉峪关市',
        children: [{ value: '620299', label: '嘉峪关市' }]
      },
      {
        value: '620300',
        label: '金昌市',
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { value: '710242', label: '仁武区' },
          { value: '710243', label: '大社区' },
          { value: '710244', label: '冈山区' },
          { value: '710245', label: '路竹区' },
          { value: '710246', label: '阿莲区' },
          { value: '710247', label: '田寮区' },
          { value: '710248', label: '燕巢区' },
          { value: '710249', label: '桥头区' },
          { value: '710250', label: '梓官区' },
          { value: '710251', label: '弥陀区' },
          { value: '710252', label: '永安区' },
          { value: '710253', label: '湖内区' },
          { value: '710254', label: '凤山区' },
          { value: '710255', label: '大寮区' },
          { value: '710256', label: '林园区' },
          { value: '710257', label: '鸟松区' },
          { value: '710258', label: '大树区' },
          { value: '710259', label: '旗山区' },
          { value: '710260', label: '美浓区' },
          { value: '710261', label: '六龟区' },
          { value: '710262', label: '内门区' },
          { value: '710263', label: '杉林区' },
          { value: '710264', label: '甲仙区' },
          { value: '710265', label: '桃源区' },
          { value: '710266', label: '那玛夏区' },
          { value: '710267', label: '茂林区' },
          { value: '710268', label: '茄萣区' }
        ]
      },
      {
        value: '710300',
        ...
        children: [
          ...
          { value: '710339', label: '永康区' },
          { value: '710340', label: '归仁区' },
          { value: '710341', label: '新化区' },
          { value: '710342', label: '左镇区' },
          { value: '710343', label: '玉井区' },
          { value: '710344', label: '楠西区' },
          { value: '710345', label: '南化区' },
          { value: '710346', label: '仁德区' },
          { value: '710347', label: '关庙区' },
          { value: '710348', label: '龙崎区' },
          { value: '710349', label: '官田区' },
          { value: '710350', label: '麻豆区' },
          { value: '710351', label: '佳里区' },
          { value: '710352', label: '西港区' },
          { value: '710353', label: '七股区' },
          { value: '710354', label: '将军区' },
          { value: '710355', label: '学甲区' },
          { value: '710356', label: '北门区' },
          { value: '710357', label: '新营区' },
          { value: '710358', label: '后壁区' },
          { value: '710359', label: '白河区' },
          { value: '710360', label: '东山区' },
          { value: '710361', label: '六甲区' },
          { value: '710362', label: '下营区' },
          { value: '710363', label: '柳营区' },
          { value: '710364', label: '盐水区' },
          { value: '710365', label: '善化区' },
          { value: '710366', label: '大内区' },
          { value: '710367', label: '山上区' },
          { value: '710368', label: '新市区' },
          { value: '710369', label: '安定区' }
        ]
      },
      {
        value: '710400',
        ...
        children: [
          ...
          { value: '710431', label: '太平区' },
          { value: '710432', label: '大里区' },
          { value: '710433', label: '雾峰区' },
          { value: '710434', label: '乌日区' },
          { value: '710435', label: '丰原区' },
          { value: '710436', label: '后里区' },
          { value: '710437', label: '石冈区' },
          { value: '710438', label: '东势区' },
          { value: '710439', label: '和平区' },
          { value: '710440', label: '新社区' },
          { value: '710441', label: '潭子区' },
          { value: '710442', label: '大雅区' },
          { value: '710443', label: '神冈区' },
          { value: '710444', label: '大肚区' },
          { value: '710445', label: '沙鹿区' },
          { value: '710446', label: '龙井区' },
          { value: '710447', label: '梧栖区' },
          { value: '710448', label: '清水区' },
          { value: '710449', label: '大甲区' },
          { value: '710450', label: '外埔区' },
          { value: '710451', label: '大安区' }
        ]
      },
      {
        value: '710600',
        label: '南投县',
        children: [
          { value: '710614', label: '南投市' },
          { value: '710615', label: '中寮乡' },
          { value: '710616', label: '草屯镇' },
          { value: '710617', label: '国姓乡' },
          { value: '710618', label: '埔里镇' },
          { value: '710619', label: '仁爱乡' },
          { value: '710620', label: '名间乡' },
          { value: '710621', label: '集集镇' },
          { value: '710622', label: '水里乡' },
          { value: '710623', label: '鱼池乡' },
          { value: '710624', label: '信义乡' },
          { value: '710625', label: '竹山镇' },
          { value: '710626', label: '鹿谷乡' }
        ]
      },
      {
        value: '710700',
      ...
      },
      {
        ...
        label: '新北市',
        children: [
          { value: '711130', label: '万里区' },
          { value: '711131', label: '金山区' },
          { value: '711132', label: '板桥区' },
          { value: '711133', label: '汐止区' },
          { value: '711134', label: '深坑区' },
          { value: '711135', label: '石碇区' },
          { value: '711136', label: '瑞芳区' },
          { value: '711137', label: '平溪区' },
          { value: '711138', label: '双溪区' },
          { value: '711139', label: '贡寮区' },
          { value: '711140', label: '新店区' },
          { value: '711141', label: '坪林区' },
          { value: '711142', label: '乌来区' },
          { value: '711143', label: '永和区' },
          { value: '711144', label: '中和区' },
          { value: '711145', label: '土城区' },
          { value: '711146', label: '三峡区' },
          { value: '711147', label: '树林区' },
          { value: '711148', label: '莺歌区' },
          { value: '711149', label: '三重区' },
          { value: '711150', label: '新庄区' },
          { value: '711151', label: '泰山区' },
          { value: '711152', label: '林口区' },
          { value: '711153', label: '芦洲区' },
          { value: '711154', label: '五股区' },
          { value: '711155', label: '八里区' },
          { value: '711156', label: '淡水区' },
          { value: '711157', label: '三芝区' },
          { value: '711158', label: '石门区' }
        ]
      },
      {
        value: '711200',
        label: '宜兰县',
        children: [
          { value: '711214', label: '宜兰市' },
          { value: '711215', label: '头城镇' },
          { value: '711216', label: '礁溪乡' },
          { value: '711217', label: '壮围乡' },
          { value: '711218', label: '员山乡' },
          { value: '711219', label: '罗东镇' },
          { value: '711220', label: '三星乡' },
          { value: '711221', label: '大同乡' },
          { value: '711222', label: '五结乡' },
          { value: '711223', label: '冬山乡' },
          { value: '711224', label: '苏澳镇' },
          { value: '711225', label: '南澳乡' }
        ]
      },
      {
        value: '711300',
        label: '新竹县',
        children: [
          { value: '711314', label: '竹北市' },
          { value: '711315', label: '湖口乡' },
          { value: '711316', label: '新丰乡' },
          { value: '711317', label: '新埔镇' },
          { value: '711318', label: '关西镇' },
          { value: '711319', label: '芎林乡' },
          { value: '711320', label: '宝山乡' },
          { value: '711321', label: '竹东镇' },
          { value: '711322', label: '五峰乡' },
          { value: '711323', label: '横山乡' },
          { value: '711324', label: '尖石乡' },
          { value: '711325', label: '北埔乡' },
          { value: '711326', label: '峨眉乡' }
        ]
      },
      {
        value: '711400',
        label: '桃园市',
        children: [
          { value: '711414', label: '中坜区' },
          { value: '711415', label: '平镇区' },
          { value: '711416', label: '龙潭区' },
          { value: '711417', label: '杨梅区' },
          { value: '711418', label: '新屋区' },
          { value: '711419', label: '观音区' },
          { value: '711420', label: '桃园区' },
          { value: '711421', label: '龟山区' },
          { value: '711422', label: '八德区' },
          { value: '711423', label: '大溪区' },
          { value: '711424', label: '复兴区' },
          { value: '711425', label: '大园区' },
          { value: '711426', label: '芦竹区' }
        ]
      },
      {
        value: '711500',
        label: '苗栗县',
        children: [
          { value: '711519', label: '竹南镇' },
          { value: '711520', label: '头份市' },
          { value: '711521', label: '三湾乡' },
          { value: '711522', label: '南庄乡' },
          { value: '711523', label: '狮潭乡' },
          { value: '711524', label: '后龙镇' },
          { value: '711525', label: '通霄镇' },
          { value: '711526', label: '苑里镇' },
          { value: '711527', label: '苗栗市' },
          { value: '711528', label: '造桥乡' },
          { value: '711529', label: '头屋乡' },
          { value: '711530', label: '公馆乡' },
          { value: '711531', label: '大湖乡' },
          { value: '711532', label: '泰安乡' },
          { value: '711533', label: '铜锣乡' },
          { value: '711534', label: '三义乡' },
          { value: '711535', label: '西湖乡' },
          { value: '711536', label: '卓兰镇' }
        ]
      },
      {
        value: '711700',
        label: '彰化县',
        children: [
          { value: '711727', label: '彰化市' },
          { value: '711728', label: '芬园乡' },
          { value: '711729', label: '花坛乡' },
          { value: '711730', label: '秀水乡' },
          { value: '711731', label: '鹿港镇' },
          { value: '711732', label: '福兴乡' },
          { value: '711733', label: '线西乡' },
          { value: '711734', label: '和美镇' },
          { value: '711735', label: '伸港乡' },
          { value: '711736', label: '员林市' },
          { value: '711737', label: '社头乡' },
          { value: '711738', label: '永靖乡' },
          { value: '711739', label: '埔心乡' },
          { value: '711740', label: '溪湖镇' },
          { value: '711741', label: '大村乡' },
          { value: '711742', label: '埔盐乡' },
          { value: '711743', label: '田中镇' },
          { value: '711744', label: '北斗镇' },
          { value: '711745', label: '田尾乡' },
          { value: '711746', label: '埤头乡' },
          { value: '711747', label: '溪州乡' },
          { value: '711748', label: '竹塘乡' },
          { value: '711749', label: '二林镇' },
          { value: '711750', label: '大城乡' },
          { value: '711751', label: '芳苑乡' },
          { value: '711752', label: '二水乡' }
        ]
      },
      {
        value: '711900',
        label: '嘉义县',
        children: [
          { value: '711919', label: '番路乡' },
          { value: '711920', label: '梅山乡' },
          { value: '711921', label: '竹崎乡' },
          { value: '711922', label: '阿里山乡' },
          { value: '711923', label: '中埔乡' },
          { value: '711924', label: '大埔乡' },
          { value: '711925', label: '水上乡' },
          { value: '711926', label: '鹿草乡' },
          { value: '711927', label: '太保市' },
          { value: '711928', label: '朴子市' },
          { value: '711929', label: '东石乡' },
          { value: '711930', label: '六脚乡' },
          { value: '711931', label: '新港乡' },
          { value: '711932', label: '民雄乡' },
          { value: '711933', label: '大林镇' },
          { value: '711934', label: '溪口乡' },
          { value: '711935', label: '义竹乡' },
          { value: '711936', label: '布袋镇' }
        ]
      },
      {
        value: '712100',
        label: '云林县',
        children: [
          { value: '712121', label: '斗南镇' },
          { value: '712122', label: '大埤乡' },
          { value: '712123', label: '虎尾镇' },
          { value: '712124', label: '土库镇' },
          { value: '712125', label: '褒忠乡' },
          { value: '712126', label: '东势乡' },
          { value: '712127', label: '台西乡' },
          { value: '712128', label: '仑背乡' },
          { value: '712129', label: '麦寮乡' },
          { value: '712130', label: '斗六市' },
          { value: '712131', label: '林内乡' },
          { value: '712132', label: '古坑乡' },
          { value: '712133', label: '莿桐乡' },
          { value: '712134', label: '西螺镇' },
          { value: '712135', label: '二仑乡' },
          { value: '712136', label: '北港镇' },
          { value: '712137', label: '水林乡' },
          { value: '712138', label: '口湖乡' },
          { value: '712139', label: '四湖乡' },
          { value: '712140', label: '元长乡' }
        ]
      },
      {
        value: '712400',
        label: '屏东县',
        children: [
          { value: '712434', label: '屏东市' },
          { value: '712435', label: '三地门乡' },
          { value: '712436', label: '雾台乡' },
          { value: '712437', label: '玛家乡' },
          { value: '712438', label: '九如乡' },
          { value: '712439', label: '里港乡' },
          { value: '712440', label: '高树乡' },
          { value: '712441', label: '盐埔乡' },
          { value: '712442', label: '长治乡' },
          { value: '712443', label: '麟洛乡' },
          { value: '712444', label: '竹田乡' },
          { value: '712445', label: '内埔乡' },
          { value: '712446', label: '万丹乡' },
          { value: '712447', label: '潮州镇' },
          { value: '712448', label: '泰武乡' },
          { value: '712449', label: '来义乡' },
          { value: '712450', label: '万峦乡' },
          { value: '712451', label: '崁顶乡' },
          { value: '712452', label: '新埤乡' },
          { value: '712453', label: '南州乡' },
          { value: '712454', label: '林边乡' },
          { value: '712455', label: '东港镇' },
          { value: '712456', label: '琉球乡' },
          { value: '712457', label: '佳冬乡' },
          { value: '712458', label: '新园乡' },
          { value: '712459', label: '枋寮乡' },
          { value: '712460', label: '枋山乡' },
          { value: '712461', label: '春日乡' },
          { value: '712462', label: '狮子乡' },
          { value: '712463', label: '车城乡' },
          { value: '712464', label: '牡丹乡' },
          { value: '712465', label: '恒春镇' },
          { value: '712466', label: '满州乡' }
        ]
      },
      {
        value: '712500',
        label: '台东县',
        children: [
          { value: '712517', label: '台东市' },
          { value: '712518', label: '绿岛乡' },
          { value: '712519', label: '兰屿乡' },
          { value: '712520', label: '延平乡' },
          { value: '712521', label: '卑南乡' },
          { value: '712522', label: '鹿野乡' },
          { value: '712523', label: '关山镇' },
          { value: '712524', label: '海端乡' },
          { value: '712525', label: '池上乡' },
          { value: '712526', label: '东河乡' },
          { value: '712527', label: '成功镇' },
          { value: '712528', label: '长滨乡' },
          { value: '712529', label: '金峰乡' },
          { value: '712530', label: '大武乡' },
          { value: '712531', label: '达仁乡' },
          { value: '712532', label: '太麻里乡' }
        ]
      },
      {
        value: '712600',
        label: '花莲县',
        children: [
          { value: '712615', label: '花莲市' },
          { value: '712616', label: '新城乡' },
          { value: '712618', label: '秀林乡' },
          { value: '712619', label: '吉安乡' },
          { value: '712620', label: '寿丰乡' },
          { value: '712621', label: '凤林镇' },
          { value: '712622', label: '光复乡' },
          { value: '712623', label: '丰滨乡' },
          { value: '712624', label: '瑞穗乡' },
          { value: '712625', label: '万荣乡' },
          { value: '712626', label: '玉里镇' },
          { value: '712627', label: '卓溪乡' },
          { value: '712628', label: '富里乡' }
        ]
      },
      {
        value: '712700',
        label: '澎湖县',
        children: [
          { value: '712707', label: '马公市' },
          { value: '712708', label: '西屿乡' },
          { value: '712709', label: '望安乡' },
          { value: '712710', label: '七美乡' },
          { value: '712711', label: '白沙乡' },
          { value: '712712', label: '湖西乡' }
        ]
      }
    ]
  },
  {
    ...
    children: [
      ...
      { value: '810105', label: '南区' },
      { value: '810106', label: '深水埗区' },
      { value: '810107', label: '湾仔区' },
      { value: '810108', label: '黄大仙区' },
      { value: '810109', label: '油尖旺区' },
      { value: '810110', label: '离岛区' },
      { value: '810111', label: '葵青区' },
      { value: '810112', label: '北区' },
      { value: '810113', label: '西贡区' },
      { value: '810114', label: '沙田区' },
      { value: '810115', label: '屯门区' },
      { value: '810116', label: '大埔区' },
      { value: '810117', label: '荃湾区' },
      { value: '810118', label: '元朗区' }
    ]
  },
  {
    value: '820000',
    label: '澳门特别行政区',
    children: [
      { value: '820101', label: '澳门半岛' },
      { value: '820102', label: '凼仔' },
      { value: '820103', label: '路凼城' },
      { value: '820104', label: '路环' }
    ]
  }
]
